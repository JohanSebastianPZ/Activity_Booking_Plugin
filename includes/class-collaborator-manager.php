    ...
    <div id="collaborator-dashboard">
        <div class="dashboard-header">
            ...
            <div class="dashboard-stats">
                <div class="stat-card">
                    <span class="stat-number"><?php echo count(array_filter($bookings, function($b) { return $b->status === 'pending_dates'; })); ?></span>
                    <span class="stat-label">Pendientes</span>
                </div>
                <div class="stat-card">
                    <span class="stat-number"><?php echo count(array_filter($bookings, function($b) { return $b->status === 'confirmed'; })); ?></span>
